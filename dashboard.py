...
#Import fit function
import nn_fit
nn_fit.opt.learning_rate.assign(1e-4)
Σ, Y, losses = nn_fit.fit_euler(num_epochs=1,batch=32,num_iters=300,tb=False,losshist=[]) 

nn_fit.opt.learning_rate.assign(1e-5)
Σ, Y, losses = nn_fit.fit_euler(num_epochs=1,batch=32,num_iters=300,tb=False,losshist=losses) 
